  ...
  <header id="header">
    <div class="container">
      ...
      <div class="logo float-left text-center">
        <h5 class="font-weight-bold text-uppercase"><a href="index.html"><span>Customer Relationship Management<br>Pondok Masa Depan Villa</span></a></h5>
          ...
          <div class="carousel-item active" style="background-image: url('mamba/assets/img/slide/slide-1.jpg');">
            <div class="carousel-container">
              <div class="carousel-content container">
                ...
                <a href="#tentang-kami" class="btn-get-started animate__animated animate__fadeInUp scrollto">Read More</a>
              </div>
            </div>
          </div>
        ...
        <div class="row no-gutters">
          ...
          <div class="col-lg-6 d-flex flex-column justify-content-center about-content">
            ...
            <div class="section-title">
              ...
              <p>Pondok Masa Depan beroperasi mulai Tahun 2018, dan sudah berdiri sejak 19 September. Didirikan oleh pasangan suami istri I Gusti Ayu Rasmini dan I Gusti lanang Ngurah ...</p>
            </div>
    ...
    <section id="aktifitas" class="services">
      <div class="container">
        ...
        <div class="row mt-5 mb-5">
          ...
          <div class="col-md-9">
            <h4>Cooking Class</h4>
            <p class="description">Pengunjung dapat mengisi waktu dengan mengikuti kelas memasak dengan menu khas Bali yang penuh bumbu dan rempah.</p>
          </div>
        </div>
        ...
        <div class="row mt-5 mb-5">
          <div class="col-md-9 text-right">
            ...
            <p class="description">Mempelajari bagaimana membuat canang sari sebagai sarana persembahyangan.</p>
          </div>
          <div class="col-md-3 icon-box" data-aos="fade-up">
            <div class="icon"><i class="icofont-computer"></i></div>
          </div>
        ...
        <div class="row mt-5 mb-5">
          ...
          <div class="col-md-9">
            ...
            <p class="description">Water Purification atau melukat adalah upacara pembersihan pikiran secara spiritual dalam diri manusia</p>
          </div>
        </div>
        ...
        <div class="row mt-5 mb-5">
          <div class="col-md-9 text-right">
            <h4>Trekking</h4>
            <p class="description">Menikmati pemandangan asri Sidemen dan menghabiskan waktu dengan berjalan-jalan di Desa ini.</p>
          </div>
          <div class="col-md-3 icon-box" data-aos="fade-up">
            <div class="icon"><i class="icofont-computer"></i></div>
          </div>
        ...
        <div class="row mt-5 mb-5">
          <div class="col-md-9 text-right">
            <h4>Yoga</h4>
            <p class="description">Melaksanakan Yoga sebagai upaya dalam menjaga kesehatan secara jasmani dan rohani.</p>
          </div>
          <div class="col-md-3 icon-box" data-aos="fade-up">
            <div class="icon"><i class="icofont-computer"></i></div>
          </div>
